<template>
  ...
  <main class="main">
    <section class="main__info">
      <SectionHeader
        :title="$t('corporateClientsPage.heroTitleTop')"
        :titleSpan="$t('corporateClientsPage.heroTitleSpan')"
        :top="$t('corporateClientsPage.heroSubtitle')"
        :descr="$t('corporateClientsPage.heroText')"
        data-aos="fade-left"
      />
    </section>
    <!--  -->
    <section class="main__build container">
      <div class="main__build-text">
        <p class="main__build-text-item">
          {{ $t("corporateClientsPage.sectionOneText1") }}
        </p>
        <p class="main__build-text-item">
          {{ $t("corporateClientsPage.sectionOneText2") }}
        </p>
      </div>
      <div class="main__build-block">
        <svg
          class="main__build-block-decor"
          width="280"
          height="401"
          viewBox="0 0 280 401"
          fill="none"
          ...
          <defs>
            ...
            >
              ...
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_4129_20681"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_4129_20681"
                result="shape"
              />
            </filter>
          </defs>
        </svg>
        <h1 class="main__build-block-title">
          {{ $t("corporateClientsPage.sectionTitle1") }}
        </h1>
      </div>
    </section>
    <!--  -->
    ...
    <section class="main__partners">
      <SectionHeader
        :title="$t('corporateClientsPage.ourClientsSectionTitle')"
        :titleSpan="$t('corporateClientsPage.ourClientsSectionTitleSpan')"
        :top="$t('corporateClientsPage.ourClientsSectionSubtitle')"
        descr=""
        data-aos="fade-left"
      />
    </section>
    <section class="main__tours">
      <SectionHeader
        :title="$t('corporateClientsPage.popularToursSectionTitle')"
        :titleSpan="$t('corporateClientsPage.popularToursSectionTitleSpan')"
        :top="$t('corporateClientsPage.popularToursSectionSubtitle')"
        :descr="$t('corporateClientsPage.popularToursSectionText')"
        data-aos="fade-left"
      />
      <WorldToursSwiper />
      <section class="main__reviews">
        <SectionHeader
          :title="$t('companyComments.companyCommentsTitle')"
          :titleSpan="$t('companyComments.companyCommentsTitleSpan')"
          :top="$t('companyComments.companyCommentsSubtitle')"
          descr=""
          data-aos="fade-left"
        />
        <ReviewBloc />
